...
def c32_promedio():
    ...
    print('El promedio de las notas de los estudiantes es: ', suma_notas/len(notas))
...
def c42_promedio():
  ...
  print('El promedio de notas del estudiantes es: ', suma_notas/len(notas))
